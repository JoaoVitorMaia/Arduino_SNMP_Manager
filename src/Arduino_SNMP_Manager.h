...
public:
    SNMPManager(){};
    SNMPManager(const char *community, short version) : _community(community), _version(version)
    {
    ...
    UDP *_udp;
    short _version;
    ValueCallback *getNextRequest(IPAddress ip, const char *oid)
    {
